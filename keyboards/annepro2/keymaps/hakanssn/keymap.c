...
// clang-format off
 ...
 [FN1] = LAYOUT_60_ansi(
    ...
    _______, _______, KC_UP,   _______, _______, _______, KC_PGDN, _______, _______, _______, _______, KC_HOME, KC_END,  _______,
    _______, KC_LEFT, KC_DOWN, KC_PGDN, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSPC, _______, _______,
